    ...
    fun createRun(request: CreateRunRequest): RunResponse {
        ...
        val run = AgentRun(
            ...
            runtime = AgentRuntime(
                ...
                userSettingsIsolated = request.runtime.userSettingsIsolated,
                shimsStripped = request.runtime.shimsStripped,
                surface = request.runtime.surface,
            ),
    ...
    fun toResponse(run: AgentRun): RunResponse {
        ...
        return RunResponse(
            ...
            runtime = RuntimeDto(
                ...
                run.runtime.version,
                run.runtime.model,
                run.runtime.userSettingsIsolated,
                run.runtime.shimsStripped,
                run.runtime.surface,
            ),
